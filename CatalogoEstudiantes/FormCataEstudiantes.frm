...
Begin VB.Form FormCataEstudiantes 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Consultar Estudiantes"
   ClientHeight    =   3825
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5970
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "FormCataEstudiantes.frx":0000
      Height          =   2535
      Left            =   120
      TabIndex        =   3
      Top             =   960
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton CmdAceptar 
         ...
         Height          =   800
         Left            =   120
         Picture         =   "FormCataEstudiantes.frx":0015
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   120
         Width           =   975
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   800
         Left            =   1080
         Picture         =   "FormCataEstudiantes.frx":0457
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   120
         Width           =   975
   ...
   End
End
Attribute VB_Name = "FormCataEstudiantes"
